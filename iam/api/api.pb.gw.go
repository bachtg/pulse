...
func request_IAMService_LoginWithGoogle_0(ctx context.Context, marshaler runtime.Marshaler, client IAMServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_IAMService_LoginWithGoogle_0(ctx context.Context, marshaler runtime.Marshaler, server IAMServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq LoginWithGoogleRequest
	var metadata runtime.ServerMetadata
...
func RegisterIAMServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IAMServiceServer) error {
	...
	mux.Handle("POST", pattern_IAMService_LoginWithGoogle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_IAMService_LoginWithGoogle_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_IAMService_LoginWithGoogle_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterIAMServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IAMServiceClient) error {
	...
	mux.Handle("POST", pattern_IAMService_LoginWithGoogle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_IAMService_LoginWithGoogle_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_IAMService_LoginWithGoogle_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "auth", "google"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_IAMService_LoginWithGoogle_0 = runtime.ForwardResponseMessage
)
